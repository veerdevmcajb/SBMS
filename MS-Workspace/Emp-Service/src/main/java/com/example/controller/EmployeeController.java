...
public class EmployeeController {
	...
	// to get the emp by dept data by empId
	@GetMapping("/findemp/{id}")
	public ResponseEntity<ResponseDto> getAllInfo(@PathVariable Integer id){
		
	ResponseDto response = empservice.getEmpWithDept(id);
